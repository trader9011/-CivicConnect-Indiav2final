...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // AuthProvider handles Firestore document creation
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Join CivicConnect to report issues and help improve your community securely.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2 col-span-2">
                  ...
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-brand-royal transition-colors" />
                    <input 
                      type="text" 
                      required
                      value={fullName}
                ...
                <div className="space-y-2 col-span-2 md:col-span-1">
                  ...
                  <div className="relative group">
                    <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-brand-royal transition-colors" />
                    <input 
                      type="tel" 
                      required
                      value={mobileNumber}
              ...
              <div className="flex items-start pt-2">
                <input 
                  ...
                  id="terms" 
                  required
                  className="mt-1 w-4 h-4 rounded border-gray-300 text-brand-royal focus:ring-brand-royal cursor-pointer" 
                />
                <label htmlFor="terms" className="ml-3 text-sm text-muted-foreground leading-relaxed cursor-pointer">
                  I agree to the <Link to="/terms" className="text-brand-royal hover:text-blue-700 transition-colors">Terms of Service</Link> and <Link to="/privacy" className="text-brand-royal hover:text-blue-700 transition-colors">Privacy Policy</Link>.
                </label>
              </div>
              ...
              >
                {isLoading ? (
                  <>
                    <PremiumInlineLoader /> Creating Secure Account...
                  </>
                ) : (
          ...
          <p className="text-center mt-8 text-muted-foreground text-sm">
            ...
            <Link to="/login" className="font-semibold text-brand-royal hover:text-blue-700 transition-colors">
              Sign in instead
            </Link>
          </p>
        </motion.div>
